  ...
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-offset-2 dark:hover:bg-zinc-800 dark:hover:text-zinc-100 disabled:opacity-50 dark:focus:ring-zinc-400 disabled:pointer-events-none dark:focus:ring-offset-zinc-900 data-[state=open]:bg-zinc-100 dark:data-[state=open]:bg-zinc-800",
  {
    variants: {
      variant: {
        ...
        outline:
          "bg-transparent border border-zinc-400 hover:bg-zinc-200 dark:border-zinc-600 dark:text-zinc-50",
        subtle:
          "bg-zinc-200 text-zinc-900 hover:bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-50",
        ghost:
          "bg-transparent hover:bg-zinc-200 dark:hover:bg-zinc-800 dark:text-zinc-50 dark:hover:text-zinc-50 data-[state=open]:bg-transparent dark:data-[state=open]:bg-transparent",
        link: "bg-transparent dark:bg-transparent underline-offset-4 hover:underline text-zinc-900 dark:text-zinc-50 hover:bg-transparent dark:hover:bg-transparent",
      },
      size: {
